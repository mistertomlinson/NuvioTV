    ...
    Column(
        ...
        SettingsGroupCard(
            ...
            LazyColumn(
                ...
                item(key = "mdblist_show_on_detail") {
                    SettingsToggleRow(
                        title = stringResource(R.string.mdblist_show_on_detail_title),
                        subtitle = stringResource(R.string.mdblist_show_on_detail_subtitle),
                        checked = uiState.showOnDetailScreen,
                        enabled = uiState.enabled,
                        onToggle = { viewModel.onEvent(MDBListSettingsEvent.ToggleShowOnDetailScreen(!uiState.showOnDetailScreen)) }
                    )
                }

                item(key = "mdblist_show_on_home") {
                    SettingsToggleRow(
                        title = stringResource(R.string.mdblist_show_on_home_title),
                        subtitle = stringResource(R.string.mdblist_show_on_home_subtitle),
                        checked = uiState.showOnHomeScreen,
                        enabled = uiState.enabled,
                        onToggle = { viewModel.onEvent(MDBListSettingsEvent.ToggleShowOnHomeScreen(!uiState.showOnHomeScreen)) }
                    )
                }
