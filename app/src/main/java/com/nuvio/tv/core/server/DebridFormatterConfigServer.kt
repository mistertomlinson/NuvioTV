...
class DebridFormatterConfigServer(
    ...
    private fun serveSettings(): Response {
        ...
        val responseJson = """{"settings":${gson.toJson(settingsMap)},"defaults":${gson.toJson(defaultsMap)}}"""
    ...
    private fun handleSettingsUpdate(session: IHTTPSession): Response {
        ...
        onSettingsChanged(DebridFormatterSettings(
    ...
    private fun errorResponse(message: String): Response =
        newFixedLengthResponse(Response.Status.BAD_REQUEST, "application/json; charset=utf-8", gson.toJson(mapOf("error" to message)))
