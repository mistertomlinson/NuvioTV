...
internal fun BoxScope.SettingsVerticalScrollIndicators(
    ...
    AnimatedVisibility(
        ...
        modifier = modifier.align(Alignment.TopCenter).padding(top = IndicatorEdgeInset),
    ...
    AnimatedVisibility(
        ...
        modifier = modifier.align(Alignment.BottomCenter).padding(bottom = IndicatorEdgeInset),
        enter = fadeIn(animationSpec = tween(INDICATOR_FADE_MS)),
        exit = fadeOut(animationSpec = tween(INDICATOR_FADE_MS))
    ) {
        Icon(
